  ...
  return (
    <div>
        ...
        <section id="glamping" className='h-full flex flex-col justify-center items-center'> 
            ...
            <p className='p-3 text-xl w-4/6'>This MMF enjoy a luxury experience by staying at the festival's glamping area. Discover all the options  on offer and choose the one that best suits your needs. Don't miss this opportunity to enjoy accommodation with all the amenities of a hotel, but under the stars.</p>
            <br></br>
        ...
        <section id="rv" className='h-full flex flex-col justify-center items-center pb-8'>
            ...
            <img className='w-4/6' src={RV} alt="rv"></img>
            <p className='p-3 text-xl w-4/6'>Drive your own RV on-site! Camp MMF offers a power hookup, RV water refills, and pump-outs for an extra charge. RV groups will be limited to the vehicle specific sleeping capacity, up to a maximum of 8 people per RV site.</p>
