...
const sectionsCamping = () => {
  return (
    <div className=' bg-black text-white'>
        <section id='camping' className='h-full flex flex-col justify-center items-center p-8 '>
        ...
        <section id="glamping" className='h-full flex flex-col justify-center items-center p-8'> 
        ...
        <section id="rv" className='h-full flex flex-col justify-center items-center p-8'>
